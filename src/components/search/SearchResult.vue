  ...
  <div class="search-result-wrap">
    ...
    <div class="search-main" v-if="!searchNull">
      ...
      <div class="search-question" v-if="SearchResult.question.length > 0">
        <h3> 问题({{SearchResult.question.length}}) <i class="icon iconfont icon-jiantou"></i></h3>
      ...
      <div class="search-school" v-if="SearchResult.school.length > 0">
        <h3> 学堂({{SearchResult.school.length}}) <i class="icon iconfont icon-jiantou"></i></h3>
            ...
            <span>
              ...
              <div class="right">
                ...
                <div class="rightBottom">
                  <a>收藏<span>{{item.collectNum}}</span></a>
                  <a>有用<span>{{item.likeNum}}</span></a>
                  <a>评论<span>{{item.commentNum}}</span></a>
                </div>
              </div>
            </li>
          </ul>
      ...
      <div class="search-evaluation" v-if="SearchResult.evaluation.length > 0">
        <h3> 评估检测（{{SearchResult.evaluation.length}}） <i class="icon iconfont icon-jiantou"></i></h3>
      ...
      <div class="search-evaluation" v-if="SearchResult.scheme.length > 0">
        <h3> 健康方案（{{SearchResult.scheme.length}}） <i class="icon iconfont icon-jiantou"></i></h3>
        <ul class="programme_list">
    ...
    methods: {
      async searchAll (val) {
        ...
        if (res.data.stateCode === '001') {
          /*if (res.data.questionList.length > 0 && this.SearchResult.school) {
